...
function [popcell] = LUCY_2013a_core(startdate,SP,F,latmax,latmin,lonmin,lonmax,WD,NOD,cityname,showimage,use_opt,opt_path,YYYYclose,YYYYtabdata,statreg,onlyurban,res,datafolder,outputfolder)
% Inputdata
% DOY - day of year,
